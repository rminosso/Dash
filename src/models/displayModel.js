...
function cadastrarDisplay(fkEmpresa, nome, id, so, ip) {
    ...
    var instrucaoSql = `
    INSERT INTO servidor(fkEmpresa, nome, numeroIdentificacao, sistemaOperacional, enderecoIp) VALUES ('${fkEmpresa}','${nome}','${id}','${so}','${ip}');
    `;
...
function cadastrarEnd(fkEmpresa, fkServidor, cep, logradouro, numero, complemento, bairro, cidade, uf) {
    ...
    var instrucaoSql = `
    INSERT INTO endereco (fkEmpresa, fkServidor, cep, logradouro, numero, complemento, bairro, cidade, uf
